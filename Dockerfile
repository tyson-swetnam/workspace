...
RUN \
    ...
    cp -f $RESOURCES_PATH/branding/cyverse-logo.svg $RESOURCES_PATH"/filebrowser/img/logo.svg"
...
LABEL \
    ...
    "org.opencontainers.image.title"="CyVerse Workspace" \
    "org.opencontainers.image.description"="All-in-one web-based development environment for machine learning." \
    "org.opencontainers.image.documentation"="https://github.com/cyverse-vice/workspace" \
    "org.opencontainers.image.url"="https://github.com/cyverse-vice/workspace" \
    "org.opencontainers.image.source"="https://github.com/cyverse-vice/workspace" \
    # "org.opencontainers.image.licenses"="Apache-2.0" \
    "org.opencontainers.image.version"=$WORKSPACE_VERSION \
    "org.opencontainers.image.vendor"="CyVerse.org" \
    "org.opencontainers.image.authors"="Tyson Swetnam, Original authors: Lukas Masuch & Benjamin Raehtlein" \
    "org.opencontainers.image.revision"=$ARG_VCS_REF \
    "org.opencontainers.image.created"=$ARG_BUILD_DATE \ 
    # Label Schema Convention (deprecated): http://label-schema.org/rc1/
    "org.label-schema.name"="CyVerse Workspace" \
    "org.label-schema.description"="All-in-one web-based development environment for machine learning." \
    "org.label-schema.usage"="https://github.com/cyverse-vice/workspace" \
    "org.label-schema.url"="https://github.com/cyverse-vice/workspace" \
    "org.label-schema.vcs-url"="https://github.com/cyverse-vice/workspace" \
    "org.label-schema.vendor"="CyVerse.org" \
